<div id="page-wrapper">
  <div id="page">
    <div id="header" class="<?php print $secondary_menu ? 'with-secondary-menu': 'without-secondary-menu'; ?> right-to-left">
      <div class="section clearfix">
        <?php if ($logo): ?>
        <a href="http://www.deutsche-digitale-bibliothek.de" target="_blank" title="<?php print t('Home'); ?>" rel="home" id="logo"> <img src="<?php print $logo; ?>" alt="<?php print t('Home'); ?>" /> </a>
        <?php endif; ?>
        ...
        <!-- /#name-and-slogan -->
        <?php endif; ?>
        <div id="fu-berlin-logo"> <a href="http://www.fu-berlin.de" target="_blank"><img src="<?php echo base_path() . "sites/all/themes/ddb_fuberlin/images/fuberlin_logo.png"; ?>" alt="<?php print t('Freie Universität Berlin'); ?>" /></a> </div>
