...
enum FlowChartStateGermany implements FlowChartState {
  ...
  LA_PLACE_AUTHOR(
      Question.AUTHOR_FROM_TRIPTIS,
      RESULT_CANT_CALCULATE,
      RESULT_PUBLIC_DOMAIN),

  LA_ORIGIN_OF_WORK2(
      Question.COUNTRY_OF_ORIGIN_TRIPTIS,
      RESULT_CANT_CALCULATE,
      LA_PLACE_AUTHOR),

  LA_CREATED_70_AGO(
      Question.CREATED_MORE_THAN_70_YEARS_AGO,
      RESULT_PUBLIC_DOMAIN,
      RESULT_NOT_PUBLIC_DOMAIN),

  LA_PUBLISHED_MORE_THAN_70_YEARS_AGO(
      Question.PUBLISHED_MORE_THAN_70_YEARS_AGO,
      RESULT_PUBLIC_DOMAIN,
      RESULT_NOT_PUBLIC_DOMAIN),
  ...
  LA_NOT_PUBLISHED_WITHIN_70_YEARS_OF_DEATH(
      Question.PUBLISHED_MORE_THAN_25_YEARS_AGO,
      RESULT_PUBLIC_DOMAIN,
      RESULT_NOT_PUBLIC_DOMAIN)
  ,
  LA_PUBLISHED2(
  ...
  LA_AUTHOR_EEA2(
      Question.WORK_PUBLISHED_OR_COMMUNICATED,
      LA_PUBLISHED2,
      LA_CREATED_70_AGO),

  LA_ORIGIN_OF_WORK(
      Question.COUNTRY_OF_ORIGIN_EEA,
      LA_AUTHOR_EEA2,
      LA_ORIGIN_OF_WORK2),

  LA_AUTHOR_ANONYMOUS(
      Question.AUTHOR_FROM_EUROPEAN_ECONOMIC_AREA,
      LA_AUTHOR_EEA2, LA_ORIGIN_OF_WORK),

  LA_AUTHOR_NOT_NATURAL(
      Question.AUTHOR_ANONYMOUS,
      LA_AUTHOR_ANONYMOUS,
      RESULT_CANT_CALCULATE),

  LA_PUBLISHED_WITHIN_70_YEARS_OF_DEATH(
      Question.AUTHOR_DIED_MORE_THAN_70_YEARS_AGO,
      RESULT_PUBLIC_DOMAIN,
      RESULT_NOT_PUBLIC_DOMAIN),

  LA_PUBLISHED(
      Question.PUBLISHED_WITHIN_70_YEARS_OF_DEATH,
      LA_PUBLISHED_WITHIN_70_YEARS_OF_DEATH,
      LA_NOT_PUBLISHED_WITHIN_70_YEARS_OF_DEATH),
  ...
  LA_AUTHOR_TYPE(
      Question.AUTHOR_NATURAL_PERSON,
      LA_AUTHOR_NATURAL,
      LA_AUTHOR_NOT_NATURAL),

  LA_OFFICIAL_DECISION(
      Question.ANNOUNCEMENT_BY_AUTHORITY,
      RESULT_PUBLIC_DOMAIN,
      LA_AUTHOR_TYPE),

  LA_GOVERNMENT_DIRECTIVE(
      Question.GOVERNMENT_DIRECTIVE,
      RESULT_PUBLIC_DOMAIN,
      LA_OFFICIAL_DECISION),

  LA_ACT_OF_PARLIAMENT(
      Question.ACT_OF_PARLIAMENT,
      RESULT_PUBLIC_DOMAIN,
      LA_GOVERNMENT_DIRECTIVE),

  LA_IS_COURT_DECISION(
      Question.COURT_DECISION_OR_DECISION_FORMULA,
  ...
  NOP_CREATED_50_YEARS_AGO(
      Question.CREATED_MORE_THAN_50_YEARS_AGO,
      RESULT_PUBLIC_DOMAIN,
      RESULT_NOT_PUBLIC_DOMAIN),

  NOP_PUBLISHED_50_YEARS_AGO(
      Question.PUBLISHED_MORE_THAN_50_YEARS_AGO,
      RESULT_PUBLIC_DOMAIN,
      RESULT_NOT_PUBLIC_DOMAIN),
  ...
  SEOW_NOT_PUBLISHED(
      Question.CREATED_MORE_THAN_25_YEARS_AGO,
      RESULT_PUBLIC_DOMAIN,
      RESULT_NOT_PUBLIC_DOMAIN),
  ...
  P_COMMUNICATED(
      Question.PUBLISHED_WITHIN_50_YEAR_AFTER_CREATION,
      P_PUBLISHED_MORE_THAN_50_YEARS_AGO,
      P_CREATED),
  ...
  BROADCAST(
      Question.FIRST_BROADCAST_25_YEARS,
      RESULT_PUBLIC_DOMAIN,
      RESULT_NOT_PUBLIC_DOMAIN),
  ...
  PER_PERFORMED_MORE_THAN_50_YEARS(
      Question.PERFORMED_MORE_THAN_50_YEARS_AGO,
      RESULT_PUBLIC_DOMAIN,
      RESULT_NOT_PUBLIC_DOMAIN),

  PER_FIXATION_PUBLISHED(
      Question.FIXATION_PUBLISHED_MORE_THAN_50_YEARS_AGO,
      RESULT_PUBLIC_DOMAIN,
      RESULT_NOT_PUBLIC_DOMAIN),

  PERFORMANCE(
      Question.FIXATION_PUBLISHED_50_YEARS_FROM_PERFORMANCE,
      PER_FIXATION_PUBLISHED,
      PER_PERFORMED_MORE_THAN_50_YEARS),
  ...
  DB_LAST_CHANGE(
      Question.CHANGED_OR_COMPLETED_WITHIN_LAST_15_YEARS,
      RESULT_NOT_PUBLIC_DOMAIN,
      RESULT_PUBLIC_DOMAIN),

  DB_LAST_15_YEARS(
      Question.PUBLISHED_IN_LAST_15_YEARS,
      RESULT_NOT_PUBLIC_DOMAIN, RESULT_PUBLIC_DOMAIN),

  DB_PUBLISHED(
      Question.PUBLISHED_AFTER_COMPLETION_OR_CHANGE,
      DB_LAST_15_YEARS,
      DB_LAST_CHANGE),

  DB_COUNTRY_RIGHTSHOLDER(
      Question.RIGHTSHOLDER_RESIDENT_EEA,
      DB_PUBLISHED,
      RESULT_PUBLIC_DOMAIN),

  DB_OPERATIONS_LINKED(
      Question.OPERATION_LINKED_TO_ECONOMY_EEA,
      DB_PUBLISHED,
      RESULT_PUBLIC_DOMAIN),

  DB_OFFICE(
      Question.COUNTRY_REGISTERED_OFFICE_EEA,
      DB_OPERATIONS_LINKED,
      RESULT_PUBLIC_DOMAIN),

  DB_COUNTRY_REGISTERED(
      Question.REGISTERED_IN_EEA,
      DB_PUBLISHED,
      RESULT_PUBLIC_DOMAIN),

  DB_FORMED_LAW(
      Question.FORMED_UNDER_LAW_OF_EEA,
      DB_COUNTRY_REGISTERED,
      DB_OFFICE),

  DATABASE(
      Question.RIGHT_HOLDER_COMPANY_OR_FIRM,
      DB_FORMED_LAW,
      DB_COUNTRY_RIGHTSHOLDER),
